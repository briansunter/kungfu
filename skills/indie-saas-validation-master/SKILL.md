...
- **Decide between multiple product concepts** and need validation data
...
Once your idea validates successfully:

1. **Scope MVP for 4-week build** - Cut ruthlessly, solve one core problem
2. **Design tiered pricing** - Start with $29/$99/$199 structure
3. **Set up development environment** - Choose boring tech stack
4. **Begin community engagement** - Start building audience pre-launch
