# Product Hunt Submission Form Guide

Complete reference for filling out every field in the Product Hunt launch form.
...
Answer: "What's new or different about your launch compared to existing
...
[1 sentence: Key technical or feature highlight]
```
...
ECS patterns to Zig with compile-time type safety, archetype-based
storage, and a plugin system. Unlike existing Zig game frameworks, Kellog
provides a full ECS with query systems, event systems, and a render
pipeline — everything you need to build 2D games without sacrificing
performance or memory safety.
```

### Launch Tags (1-3 required)
...
Posted immediately upon launch. See
[first-comment-templates.md](first-comment-templates.md) for complete templates.
...
- **Steam**: Game store link
- **Amazon**: Physical product or Kindle link
- **GitHub**: Repository link (especially for open source)

### Open Source Project

Toggle yes/no. If yes, include GitHub link in the Links section. Open source
products get a special badge on Product Hunt.
...
4. Feature screenshot 2 with annotation
5. Feature screenshot 3 with annotation
6. Demo GIF or video
7. Social proof / testimonials
8. Pricing or getting started

### Makers

Tag all team members who have Product Hunt accounts. Makers can respond to
comments and get credit on their profiles.
...
- **Schedule launches** for 12:01 AM PT for maximum visibility
- **Tuesday, Wednesday, Thursday** get the most traffic
- **Avoid**: Mondays (busy), Fridays (low engagement), weekends
- **Check the calendar**: Avoid days when major products are launching

## Pre-Launch Checklist

- [ ] Name within 12-40 characters
- [ ] Tagline within 60 characters, communicates core benefit
- [ ] Description within 500 characters, answers "what's different?"
- [ ] 1-3 launch tags selected
- [ ] Gallery has 4-8 high-quality assets
- [ ] First comment drafted and ready
- [ ] All links added and tested
- [ ] Makers tagged
