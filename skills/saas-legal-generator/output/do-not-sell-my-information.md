...
**Submit to:** legal@antigravity.test **Subject:** CCPA Opt-Out Request
...
If you have an account with Antigravity Test Co, you can opt-out by:
...
- **antigravity.test/privacy-rights** - Submit a rights request
- **antigravity.test/privacy** - View our full Privacy Policy
- **Contact us:** legal@antigravity.test
...
1. Email: legal@antigravity.test
2. Subject: "CCPA Opt-Out Request"
3. Include: Name, email, state (California)

**Account Settings:** antigravity.test/account/settings/privacy
