...
To use certain features of the Service, you must create an account. You agree
to:
...
- Terminate accounts that are inactive for [INACTIVITY_PERIOD] months
...
We offer various subscription plans with different features and pricing. Plan
details are available on our website at antigravity.test/pricing.

### 4.2 Fees and Payment

- You agree to pay all fees associated with your chosen subscription plan
- Fees are charged in USD on a Monthly basis
- All fees are non-refundable except as required by law
- We may change our fees at any time with [NOTICE_PERIOD] days' notice
...
- We may offer a 30-day money-back guarantee for new subscriptions
- To request a refund, contact legal@antigravity.test
...
- Access the Service using automated means (e.g., bots, scrapers)
...
If the Service allows you to upload, post, or submit content, you agree not to
submit content that:
...
violations of this Acceptable Use Policy, including account termination and
legal action.
...
Antigravity Test Co and are protected by international copyright, trademark, and
...
display, and distribute your content solely for the purpose of providing the
Service.

### 6.3 Feedback

If you provide feedback, suggestions, or ideas about the Service, you grant us
the right to use such feedback without obligation to compensate you.
...
We target [UPTIME_PERCENTAGE]% uptime, excluding scheduled maintenance.

### 8.2 Maintenance

We may perform scheduled maintenance with reasonable notice. Emergency
...
- Email: support@antigravity.test
- Knowledge Base: antigravity.test/help
- Response Time: We aim to respond within [RESPONSE_TIME]
...
- **Amount Exceeding Fees Paid:** Our total liability shall not exceed the fees
  you paid for the Service in the [TIMEFRAME] months preceding the claim
- **Third-Party Actions:** Damages caused by third parties or third-party
  services
- **Force Majeure:** Failures due to events beyond our reasonable control
...
You agree to indemnify, defend, and hold harmless Antigravity Test Co and its
...
We implement reasonable security measures to protect your data. However, we
cannot guarantee absolute security and are not responsible for unauthorized
access due to factors beyond our control.

### 11.3 Data Backup and Recovery

We regularly back up data and maintain disaster recovery procedures. However,
...
- Contacting legal@antigravity.test
- Providing [NOTICE_PERIOD] days' notice for annual subscriptions
...
- Your right to use the Service will end immediately
- We may delete your data after 730 days
- You remain liable for all fees incurred before termination
- Sections that by their nature should survive termination will continue
...
- Providing at least [NOTICE_PERIOD] days' notice before changes take effect

Your continued use of the Service after modifications constitutes acceptance of
the new Terms.
...
**[MUTUAL_ARBITRATION_OPTION: INCLUDE/EXCLUDE]**
...
[ARBITRATION_ORGANIZATION].

**Exceptions:** Either party may bring claims in small claims court.
...
These Terms, together with our Privacy Policy and any applicable DPA, constitute
the entire agreement between you and Antigravity Test Co.
...
control, including natural disasters, war, strikes, or government actions.

## 16. Third-Party Services

The Service may integrate with third-party services or APIs. Your use of
third-party services is subject to their terms and conditions. We are not
responsible for the practices or policies of third parties.

## 17. Compliance with Export Laws

You agree to comply with all applicable export control laws and regulations. You
may not use the Service in violation of any export laws.

## 18. Electronic Communications

By using the Service, you consent to receive electronic communications from us,
including emails, notifications, and postings on our website.
...
**Thank you for using Antigravity Test Co!**

**Terms Version:** 1.0 **Effective Date:** January 24, 2026
